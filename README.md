...
Instructions This activity is broken down into two deliverables, WeatherPy and VacationPy.
...
Hints and Considerations The city data that you generate is based on random coordinates and different query times, so your outputs will not be an exact match to the provided starter notebook.
